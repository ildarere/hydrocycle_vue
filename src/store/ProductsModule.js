        ...
        filters.forEach(filter => {
          switch (filter.filter) {
            case 'category':
              ...
              break
            case 'priceBottom':
              product.finalPrice >= filter.value
                ? isMatchP.push(true)
                : isMatchP.push(false)
              break
            case 'priceTop':
